...
<html>
	...
	<!-- Theme style  -->
	<link rel="stylesheet" href="${initParam.rootPath}/template/css/style.css">

	<!-- Modernizr JS -->
	<script src="${initParam.rootPath}/template/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
			...
			<div class="row">			
				...
				<div class="col-xs-6 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="${initParam.rootPath}/about.do">About Us</a></li>
					</ul>
				</div>
			</div>
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(${initParam.rootPath}/template/images/img_bg_1.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="${initParam.rootPath}/template/images/work-1.jpg" alt="Free HTML5 Website Template by gettemplates.co" class="img-responsive">
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="${initParam.rootPath}/template/images/work-2.jpg" alt="Free HTML5 Website Template by gettemplates.co" class="img-responsive">
						<div class="fh5co-copy">
							<h3>Smart Layers</h3>
							<p>Brand &amp; Identity</p>
						</div>
				...
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="${initParam.rootPath}/template/images/work-3.jpg" alt="Free HTML5 Website Template by gettemplates.co" class="img-responsive">
						<div class="fh5co-copy">
			...
			<div class="row">
				<div class="col-md-6 animate-box">
					<div class="testimonial">
						<blockquote>
							...
							<p class="author"> <img src="${initParam.rootPath}/template/images/person1.jpg" alt="Free HTML5 Bootstrap Template by gettemplates.co"> <cite>&mdash; Mike Adam</cite></p>
						</blockquote>
					</div>
					...
					<div class="testimonial fh5co-selected">
						<blockquote>
							...
							<p class="author"><img src="${initParam.rootPath}/template/images/person2.jpg" alt="Free HTML5 Bootstrap Template by gettemplates.co"> <cite>&mdash; Eric Miller</cite></p>
						</blockquote>
					</div>
				</div>
				...
				<div class="col-md-6 animate-box">
					<div class="testimonial fh5co-selected">
						<blockquote>
							<p>&ldquo;Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius. Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit. Eos cumque dicta adipisci architecto culpa amet.&rdquo;</p>
							<p class="author"><img src="${initParam.rootPath}/template/images/person3.jpg" alt="Free HTML5 Bootstrap Template by gettemplates.co"> <cite>&mdash; Eric Miller</cite></p>
						</blockquote>
					</div>
	...
	<!-- jQuery -->
	<script src="${initParam.rootPath}/template/js/jquery.min.js"></script>
	<!-- jQuery Easing -->
	...
	<!-- Main -->
	<script src="${initParam.rootPath}/template/js/main.js"></script>
