...
<head>
	...
	$(document).ready(function() {
		...
		/* $(document).on("click", "#add-it-btn", function(){
			var formData = $("#journal-add-form").serializeArray();
			$.ajax({
				"url": "${initParam.rootPath }/journal/addJournalPop_up.do",
				"type": "post",
				"data": formData,
				"dataType":"text",
	...
	function dropImageList(target){
		...
		$("form#modify-journal-form").append('<input type="text" name="dropImage" value="'+dropImage+'">');
		$("#drop-image-list").append($(target).parent());
...
<!-- 사진 확대 모달 -->
	...
	<form id="journal-add-form" action="${ initParam.rootPath }/journal/add.do" enctype="multipart/form-data" method="post">
			...
			<div class="row animate-box row-pb-md" data-animate-effect="fadeInUp">
				<div id="add-journal" class="col-md-8 col-md-offset-2 text-left fh5co-heading">
						...
						<div class="col-md-12" id="journal-btn-wrap">
							...
							<div class="col-md-6 col-sm-6 animate-box" data-animate-effect="fadeInUp">
								<button type="reset" id="cancel-btn" class="btn btn-lg btn-default" onclick="closeThisPage();" style="width:100%">Cancel</button>
							</div>
						</div>
